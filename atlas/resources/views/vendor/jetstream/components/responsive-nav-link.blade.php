...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-pink-400 text-base font-medium text-pink-500 bg-indigo-50 focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-pink-500 transition'
